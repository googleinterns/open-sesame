...
public class MockGHObjects {
   ...
   * functions predefined; getBio() -> MOCK_BIO getAvatarUrl() -> MOCK_AVATAR_URL getLocation() ->
   * MOCK_LOCATION getName() -> MOCK_NAME getHtmlUrl().toString() -> MOCK_HTML_URL;
   *
   ...
   * following functions predefined; getDescription() -> MOCK_DESCRIPTION getLanguage() ->
   * MOCK_LANGUAGE getName() -> MOCK_REPO_NAME listTopics() -> MOCK_TOPICS
   *
   * <p>NOTE: all functions return fixtures defined in this class
   *
   * @return a mocked instance of a GHUser
