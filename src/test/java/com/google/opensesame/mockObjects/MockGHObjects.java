...
public class MockGHObjects {
   ...
   * 
   * <p>NOTE: all functions return fixtures defined in this class. MOCK_HTML_URL()
   * is a function due to complications with Java's URL Class.
  ...
  public static String MOCK_LANGUAGE = "MOCK_LANGUAGE";
   ...
   /**
    * Creates an instance of a GHRepository mocked with Mockito. The mocked
    * repository comes with the following functions predefined; 
