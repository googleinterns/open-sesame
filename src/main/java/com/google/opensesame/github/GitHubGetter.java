...
public final class GitHubGetter {
   ...
   * If credentials are available in the system environment variables, the builder will connect
   * to the GitHub API using those. Otherwise, it will connect anonymously.
   * 
  ...
  /**
   * Builds the GitHub interface from credentials or with an anonymous connection if the
