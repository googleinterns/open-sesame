...
/**
 * The Person Entity is designed to directly interface with datastore using Objectify. It holds the
 * neccesary information to generate an UserObject that before the user has chosen to be a mentor
 * for any project.
 */
@Entity
