...
/** 
 * The Mentor Entity is designed to directly interface with datastore using 
 * Objectify. It holds the neccesary information to generate an UserObject that
 * has chosen to mentor for a project.
 */
@Subclass(index = true)
public class MentorEntity extends PersonEntity {
  ...
  /** 
   * Datastore IDs of mentees that have expressed interest in being mentored by
   * this user. 
   */  
