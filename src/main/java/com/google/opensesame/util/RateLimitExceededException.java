 ...
 *
 * <p>NOTE: When this Exception is caught, the appropriate error code to throw is an HTML_FORBIDDEN
 * (403). This is to stay consistent with the GitHub Restful API convention found <a
